// The slice of QuincyBounty the serverless sync route needs: the seven
// events (as poll triggers) plus the two view getters it calls to rebuild
// each row. Kept in sync with indexer/src/abi.ts and smartcontract/src/QuincyBounty.sol.
